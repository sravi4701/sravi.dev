...
export const profile: Profile = {
  ...
  bio: [
    ...
    "At TheTripGuru I own the OTA distribution stack that carries most of the company's bookings, and I built the automation that turns partner confirmation emails into real bookings without anyone typing them in. I also designed the agentic development workflow the engineering team now uses to go from ticket to merged pull request.",
